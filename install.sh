#!/usr/bin/env sh
# Universal installer for geoaoi-pro. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/geoaoi-pro.git"
echo "Installing geoaoi-pro ..."
